...
{
    /// <summary>
    /// Represents errors that occur during migration.
    /// </summary>
    public class MongoDbMigrationsException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MongoDbMigrationsException"/> class with a specified error message.
        /// </summary>
